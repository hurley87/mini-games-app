...
export default function InfoPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: 'Earn Tokens',
      description:
        'Each game has its own token that can be earned through gameplay',
    ...
    },
    {
      ...
      title: 'Trade on Zora',
      description:
        "All game tokens are tradeable on Zora's decentralized marketplace",
    ...
    },
    {
      ...
      title: 'Compete & Win',
      description:
        'Climb leaderboards and earn rewards based on your performance',
      color: 'text-blue-400',
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      title: 'Choose a Game',
      description:
        'Browse our collection of mini-games and pick one that interests you',
      icon: Target,
    },
    {
      step: 2,
      ...
      description:
        'Get a free trial on your first play, then use tokens for unlimited access',
      icon: Play,
    },
    {
      step: 3,
      ...
      description:
        'Your performance is recorded onchain and added to the leaderboard',
      icon: Trophy,
    },
    {
      step: 4,
      title: 'Earn Rewards',
      description:
        'Top players receive token rewards distributed by game creators',
      icon: Gift,
    },
  ];
  ...
  const tokenomics = [
    {
      ...
      description:
        'Buy tokens directly from the game page at the current market price',
  ...
  const faqs = [
    {
      ...
      answer:
        "You just need a Farcaster account! Each game offers a free first play. After that, you'll need to hold at least 0.001 of the game's token to continue playing.",
    },
    {
      question: 'How do game tokens work?',
      answer:
        'Each game deploys its own ERC-20 token on Base. These tokens grant access to play the game and can be earned through gameplay, purchased directly, or traded on secondary markets.',
    },
    {
      question: 'Can I create my own game?',
      answer:
        'Yes! Mini Games is a platform for creators. You can build and deploy your own games, set up token economics, and distribute rewards to players.',
    },
    {
      question: 'Are my scores stored onchain?',
      answer:
        'Game scores and leaderboards are currently stored off-chain for efficiency, but token ownership and transfers happen entirely onchain.',
    },
    {
      question: 'What blockchain is this built on?',
      answer:
        'Mini Games is built on Base, an Ethereum Layer 2 that offers fast, affordable transactions perfect for gaming.',
    },
    {
      question: 'How do I withdraw my tokens?',
      answer:
        'Tokens are automatically sent to your connected wallet. You can manage them like any other cryptocurrency - send, trade, or hold them.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 pt-20 pb-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            ...
            Play, earn, and trade game tokens in a decentralized gaming
            ecosystem.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-sm text-white/70">
                Your tokens and achievements are stored onchain, giving you true
                ownership
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-white/70">
                Built by and for the Farcaster community with creator-first
                economics
              </p>
            </div>
            <div>
              ...
              <p className="text-sm text-white/70">
                Play directly in Farcaster frames - no app downloads or
                installations
              </p>
            </div>
          </div>
